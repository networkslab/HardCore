...
echo "Training..."
python main.py -c configs/${exp_name}.yaml --seed $seed --version gen_and_20full_split_0 --device 1 --split_idx 0 --debug > lightning_logs/${exp_name}/split_0_log.txt &
python main.py -c configs/${exp_name}.yaml --seed $seed --version gen_and_20full_split_1 --device 2 --split_idx 1 --debug > lightning_logs/${exp_name}/split_1_log.txt &
# python main.py -c configs/${exp_name}.yaml --seed $seed --version seed_${seed}_split_2 --device 4 --split_idx 2 --debug > lightning_logs/${exp_name}/split_2_log.txt &
# python main.py -c configs/${exp_name}.yaml --seed $seed --version seed_${seed}_split_3 --device 0 --split_idx 3 --debug > lightning_logs/${exp_name}/split_3_log.txt &
# python main.py -c configs/${exp_name}.yaml --seed $seed --version seed_${seed}_split_4 --device 0 --split_idx 4 --debug > lightning_logs/${exp_name}/split_4_log.txt &
